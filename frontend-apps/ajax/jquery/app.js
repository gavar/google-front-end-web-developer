...
(function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        // images
        $.ajax(`https://api.unsplash.com/search/photos?page=1&query=${searchedForText}`, {
            headers: {Authorization: `Client-ID 2acbcbf1a1639b8d3af2915f3bf412a2a8bf588627750709fb25d2d96ab8d164`},
        }).done(addImage);

        // articles
        $.ajax(`http://api.nytimes.com/svc/search/v2/articlesearch.json?q=${searchedForText}&api-key=118f320ef2b64ef7b616e36572866f5b`)
            .done(addArticles);
    });
